...
<head>
    ...
    <meta charset="utf-8" />
    <title>Thêm Mã Khuyến Mãi | TechZ</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Thêm mã khuyến mãi</h4>
                                </div><!-- end card header -->

                                <div class="card-body">

                                    <div class="live-preview">
                                        <form action="?act=them-ma-khuyen-mai" method="POST">
                                            <div class="row">
                                                <div class="col-12 mb-3">
                                                    <div>
                                                        <label for="ten_ma" class="form-label">Tên khuyến mãi:</label>
                                                        <input type="text" class="form-control" placeholder="Nhập tên khuyến mãi" id="ten_ma" name="ten_ma">
                                                ...
                                                <div class="col-12 mb-3">
                                                    <div>
                                                        ...
                                                        <input type="number" class="form-control" min="0" placeholder="Nhập tên giá giảm" id="gia_giam" name="gia_ma">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-12 mb-3">
                                                    <div>
                                                        ...
                                                        <input type="number" class="form-control" min="0" placeholder="Nhập số lượng mã" name="so_luong" id="so_luong">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="exampleInputdate" name="ngay_bat_dau">
                                                    <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" id="exampleInputdate" name="ngay_ket_thuc">
                                                    <span class="text-danger">
