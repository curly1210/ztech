...
<head>
  ...
  <meta charset="utf-8" />
  <title>Cập Nhật Sản Phẩm | TechZ</title>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="?act=sua-san-pham" method="post" enctype="multipart/form-data">
                    <input placeholder="Nhập tên sản phẩm" style="display: none;" name="id" value="<?= $sanPham['id'] ?>" type="text" class="form-control" id="gen-info-email-input">

                    <div class="row">
                      <div class="col-lg-4">
                        <div class="mb-3">
                          <label class="form-label" for="gen-info-email-input">Tên sản phẩm</label>
                          <input placeholder="Nhập tên sản phẩm" name="ten" value="<?= $sanPham['ten'] ?>" type="text" class="form-control" id="gen-info-email-input">
                      ...
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input placeholder="Nhập mô tả" name="mo_ta" value="<?= $sanPham['mo_ta'] ?>" type="text" class="form-control" id="gen-info-username-input">
                          <span class="text-danger">
                        ...
                        <div class="mb-3">
                          ...
                          <select name="danh_muc" class="form-select">
                            ...
                            <?php foreach ($danhMucs as $row) { ?>
                              <?php if ($sanPham['danh_muc_id'] == $row['id']) { ?>
                                <option selected value="<?= $row['id'] ?>"><?= $row['ten'] ?></option>
                              <?php } else { ?>
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input placeholder="Nhập giá nhập" name="gia_nhap" value="<?= $sanPham['gia_nhap'] ?>" type="number" class="form-control" id="gen-info-email-input">
                          <span class="text-danger">
                      ...
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input placeholder="Nhập giá bán" name="gia_ban" value="<?= $sanPham['gia_ban'] ?>" type="number" class="form-control" id="gen-info-email-input">
                          <span class="text-danger">
                      ...
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input placeholder="Nhập giá khuyến mãi" name="gia_khuyen_mai" value="<?= $sanPham['gia_khuyen_mai'] ?>" type="number" class="form-control" id="gen-info-email-input">
                          <span class="text-danger">
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input type="date" name="ngay_nhap" value="<?php echo date("Y-m-d", strtotime($sanPham['ngay_nhap'])) ?>" class="form-control">
                          <span class="text-danger">
                      ...
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <input placeholder="Nhập số lượng" name="so_luong" value="<?= $sanPham['hang_ton_kho'] ?>" type="number" class="form-control" id="gen-info-email-input">
                          <span class="text-danger">
                      ...
                      <div class="col-lg-4">
                        <div class="mb-3">
                          ...
                          <select name="trang_thai" class="form-select">
                            <option <?php if ($sanPham['trang_thai'] == 2) { ?> selected <?php } ?> value="2">Hiển thị</option>
                            <option <?php if ($sanPham['trang_thai'] == 1) { ?> selected <?php } ?> value="1">Ẩn</option>
                          </select>
                          <span class="text-danger">
                    ...
                    <div class=" mb-3">
                      ...
                      <input type="file" name="hinh_anh[]" value="sdsd" multiple class="form-control">
                      <span class="text-danger">
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control ckeditor" id="ckeditor" name="mo_ta_chi_tiet"><?= $sanPham['mo_ta_chi_tiet'] ?></textarea>
                      <span class="text-danger">
