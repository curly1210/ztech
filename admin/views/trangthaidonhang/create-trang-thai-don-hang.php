...
<head>
    ...
    <meta charset="utf-8" />
    <title>Thêm Trạng Thái Đơn Hàng | TechZ</title>
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Tạo mới trạng thái đơn hàng</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header  ">
                                    <h4 class="card-title mb-0 flex-grow-1">Tạo mới trạng thái đơn hàng</h4>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="?act=them-trang-thai-don-hang" method="post">
                                        ...
                                        <div class="mb-3 w-25">
                                            ...
                                            <input name="ten" type="text" class="form-control" id="gen-info-email-input">
                                        ...
                                        <div class="mb-3 w-25">
                                            ...
                                            <input name="mau" type="color" class="form-control form-control-color w-100" id="colorPicker" value="#364574">
