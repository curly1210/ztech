...
SELECT
    ...
    COALESCE((SELECT COUNT(*)
              ...
              WHERE nguoi_dungs.id= :id AND don_hangs.id_trang_thai_don_hang = 7), 0) AS don_hang_huy,
    COALESCE((SELECT COUNT(*)
              FROM don_hangs
               JOIN nguoi_dungs ON nguoi_dungs.id = don_hangs.id_nguoi_dung
              WHERE nguoi_dungs.id= :id AND don_hangs.id_trang_thai_don_hang IN (6, 8, 9, 10, 12)), 0) AS don_hang_dat,
