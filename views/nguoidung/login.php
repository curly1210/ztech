...
<head>
  ...
  <?php
  require_once "./admin/views/layouts/libs_css.php";
  ?>
...
<body>
                  ...
                  <form action="?act=dang-nhap" method="post">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="position-relative auth-pass-inputgroup mb-3">
                        <input type="password" name="mat_khau" class="form-control pe-5 password-input" placeholder="Nhập mật khẩu" id="password-input">
                        <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon material-shadow-none" type="button" id="password-addon"><i class="ri-eye-fill align-middle"></i></button>
                        <span class="text-danger">
                          <?= !empty($_SESSION['errors']['matKhau']) ? $_SESSION['errors']['matKhau'] : '' ?>
                        </span>
                      </div>
                    </div>
  ...
  <!-- JAVASCRIPT -->
  <?php
  require_once "./admin/views/layouts/libs_js.php";
  ?>
</body>
